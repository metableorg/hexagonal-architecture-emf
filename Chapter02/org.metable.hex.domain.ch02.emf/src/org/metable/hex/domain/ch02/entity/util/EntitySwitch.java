...
public class EntitySwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case EntityPackage.EVENT_EMF: {
                ...
                if (result == null) result = caseIEvent(eventEmf);
            ...
            case EntityPackage.SWITCH_EMF: {
                ...
                if (result == null) result = caseISwitch(switchEmf);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case EntityPackage.ROUTER_EMF: {
                ...
                if (result == null) result = caseIRouter(routerEmf);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Event Emf</em>'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Switch Emf</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Router Emf</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
