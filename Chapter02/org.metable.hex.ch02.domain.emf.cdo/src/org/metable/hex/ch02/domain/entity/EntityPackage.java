...
public class EntityPackage extends EPackageImpl {
     ...
     * @ordered
     */
    public static final int SWITCH_EMF__ID = ISWITCH_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    public static final int SWITCH_EMF__TYPE = ISWITCH_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    public static final int SWITCH_EMF__ADDRESS = ISWITCH_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
    public static final int SWITCH_EMF__NETWORKS = ISWITCH_FEATURE_COUNT + 3;
     ...
     * @ordered
     */
    public static final int SWITCH_EMF_FEATURE_COUNT = ISWITCH_FEATURE_COUNT + 4;
     ...
     * @ordered
     */
    public static final int ROUTER_EMF__ID = IROUTER_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    public static final int ROUTER_EMF__SWITCH = IROUTER_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    public static final int ROUTER_EMF__TYPE = IROUTER_FEATURE_COUNT + 2;
    ...
    public EReference getRouterEmf_Switch() {
        return (EReference) routerEmfEClass.getEStructuralFeatures().get(1);
    }
    ...
    public EAttribute getRouterEmf_Type() {
        return (EAttribute) routerEmfEClass.getEStructuralFeatures().get(2);
    }
